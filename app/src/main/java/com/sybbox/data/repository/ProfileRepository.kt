...
private fun ProfileEntity.toDomain() = ServerProfile(
    ...
    grpcServiceName = grpcServiceName, xhttpMode = xhttpMode,
    xhttpExtra = xhttpExtra, multiplexEnabled = multiplexEnabled,
    ...
    wgPrivateKey = com.sybbox.data.parser.WireGuardParser.cleanKey(wgPrivateKey),
    wgPeerPublicKey = com.sybbox.data.parser.WireGuardParser.cleanKey(wgPeerPublicKey),
    wgPresharedKey = wgPresharedKey.takeIf { it.isBlank() } ?: com.sybbox.data.parser.WireGuardParser.cleanKey(wgPresharedKey),
    wgReserved = wgReserved.split(",").mapNotNull { it.toIntOrNull() },
    wgLocalAddress = wgLocalAddress, wgMTU = wgMTU,
    wgJc = wgJc, wgJmin = wgJmin, wgJmax = wgJmax, wgS1 = wgS1, wgS2 = wgS2,
    wgH1 = wgH1, wgH2 = wgH2, wgH3 = wgH3, wgH4 = wgH4,
    ssPlugin = ssPlugin, ssPluginOpts = ssPluginOpts,
